...
class Operations:
    ...
    def EvalCKKStoFHEWSetup(self, schswchparams: SchSwchParams) -> LWEPrivateKey: 
        pass
    def EvalChebyshevFunction(self, func: Callable[[float], float], ciphertext: Ciphertext, a: float, b: float, degree: int) -> Ciphertext: 
        pass
    ...
    def EvalInnerProduct(*args, **kwargs): 
        pass
    def EvalLinearWSum(self, ciphertext: List[Ciphertext], coefficients: List[float]) -> Ciphertext: 
        pass
    def EvalLinearWSumMutable(self, ciphertext: List[float], coefficients: List[Ciphertext]) -> Ciphertext: 
        pass
