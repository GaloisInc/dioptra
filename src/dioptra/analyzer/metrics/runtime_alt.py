from dioptra.analyzer.metrics.analysisbase import AnalysisBase, Ciphertext, Plaintext, PublicKey, PrivateKey, Value
...
class Runtime(AnalysisBase):
    ...
    def set_runtime(self, ct: Value, runtime: int, call_loc: Frame) -> None:
