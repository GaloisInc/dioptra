...
class Runtime(AnalysisBase):
    ...
    def trace_encode_ckks(self, dest: Plaintext, call_loc: Frame) -> None:
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.ENCODE, dest.level)
        )
    ...
    def trace_encrypt(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.ENCRYPT, dest_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_decrypt(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.DECRYPT, ct_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_mul_ctct(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_MULT_CTCT, ct1_depth, ct2_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_add_ctct(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_ADD_CTCT, ct1_depth, ct2_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_sub_ctct(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_SUB_CTCT, ct1_depth, ct2_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_mul_ctpt(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_MULT_CTPT, ct_depth, pt_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_add_ctpt(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_ADD_CTPT, ct_depth, pt_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_sub_ctpt(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_SUB_CTPT, ct_depth, pt_depth)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
    ...
    def trace_bootstrap(
        ...
        line_runtime = self.runtime_table.get_runtime_ns(
            Event(EventKind.EVAL_BOOTSTRAP)
        )
        self.total_runtime += line_runtime
        self.set_runtime(dest, line_runtime, call_loc)
