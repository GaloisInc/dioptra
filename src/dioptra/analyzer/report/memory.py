...
class MemoryReport:
  ...
  def record_alloc(self, ty: AllocationType, value_id: int, size: int, loc: Frame|None):
    pass

  def record_dealloc(self, ty: AllocationType, value_id: int, size: int, loc: Frame|None):
    pass
